...
async function getPushConfig() {
  try {
    ...
    return cfg || { checkInterval: 8, priceFallDays: 14, cacheTtl: 12, pushNotificationsEnabled: false, pushOnPriceRise: false, priceCheckMode: 'average' };
  } catch(e) { return { checkInterval: 8, priceFallDays: 14, cacheTtl: 12, pushNotificationsEnabled: false, pushOnPriceRise: false, priceCheckMode: 'average' }; }
}
